...
export const Article = () => {
  return (
    <Link href="/artigo" className="bg-[#fff] drop-shadow-xl overflow-hidden group relative rounded-md flex gap-3">
      <div>
        <div className="relative  h-52 w-[900px] overflow-hidden">
          <Image 
        ...
        <div className="p-3">
          <p className="text-dark-gray text-lg font-bold">Título do artigo</p>
